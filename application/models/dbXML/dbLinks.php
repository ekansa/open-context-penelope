     ...
     public function getPersonsFromOrigin($id, $obs = false){
        ...
        $db = $this->db;
		  ...
		  if($this->dbPenelope){
				...
				$sql = "SELECT links.link_uuid, links.targ_uuid, links.link_type, links.targ_obs,
				...
				SELECT links.link_uuid, links.targ_uuid, links.link_type, links.targ_obs,
				...
				$sql = "SELECT links.link_uuid, links.targ_uuid, links.link_type, links.targ_obs,
				persons.combined_name AS combined_name, persons.last_name, persons.first_name, persons.mid_init AS mid_init
				FROM links 
				JOIN persons ON persons.uuid = links.targ_uuid
				WHERE links.origin_uuid = '".$id."'
				AND (links.targ_type LIKE '%person%'  )
		  ...
		  //echo $sql;
				...
				if($result){
					 ...
					 foreach($result as $row){
						  ...
						  $actPersonLinkArray = array(
										  "linkRelUUID" => $linkRelUUID,
    ...
    public function getSpaceFromOrigin($id, $obs = false){
        ...
        $db = $this->db;
		  ...
		  if($this->dbPenelope){
				...
				$sql = "SELECT links.link_uuid, links.targ_uuid, links.link_type, links.targ_obs, space.class_uuid, space.space_label
				FROM links 
    ...
    public function getSpaceFromTarg($id, $obs = false){
        ...
        $db = $this->db;
		  ...
		  if($this->dbPenelope){
				...
				$sql = "SELECT links.link_uuid, links.origin_uuid, links.link_type, links.origin_obs, space.class_uuid, space.space_label
				FROM links 
