						...
						<div id="item_top_tab">
								<div id="item_top_row">
										...
										<div id="item_top_des_cell">
												<h2 class="top_detail"><xsl:if test="arch:spatialUnit/@ownedBy !=0">Project: <a><xsl:attribute name="href">project?UUID=<xsl:value-of select="arch:spatialUnit/@ownedBy"/></xsl:attribute><xsl:value-of select="arch:spatialUnit/oc:metadata/oc:project_name"/></a></xsl:if><xsl:if test="arch:spatialUnit/@ownedBy =0">Open Context</xsl:if></h2>
										...
										<div id="right_des">
												...
												<div id="media-links">
														<h5>Linked Media (<xsl:value-of select="count(descendant::arch:spatialUnit/arch:observations/arch:observation/arch:links/oc:media_links/oc:link)"/>)</h5>
														  ...
														  <p>
																  <a>
																		  <xsl:attribute name="href">space?UUID=<xsl:value-of select="arch:spatialUnit/@UUID"/>.xml</xsl:attribute>
