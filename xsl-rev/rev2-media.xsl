						...
						<div id="item_top_tab">
								<div id="item_top_row">
										...
										<div id="item_top_des_cell">
												<h2 class="top_detail">Project: <a><xsl:attribute name="href">project?UUID=<xsl:if test="arch:resource/@ownedBy !=0"><xsl:value-of select="arch:resource/@ownedBy"/></xsl:if></xsl:attribute><xsl:value-of select="arch:resource/oc:metadata/oc:project_name"/></a></h2>
						...
						<div id="item_context_tab">
								<div id="item_context_row" class="awld-scope">
										...
										<div id="item_context_cell">
												...
												<a><xsl:attribute name="href">space?UUID=<xsl:value-of select="arch:resource/arch:links/oc:space_links/oc:link[1]/oc:id"/></xsl:attribute>
								...
								<div id="main_description_row">
												...
												<div id="media-preview-des">
														...
														<div id="preview">
																...
																<div id="image_area">
																		...
																		<xsl:otherwise>
																		<a><xsl:attribute name="href"><xsl:value-of select="arch:resource/arch:content/arch:externalFileInfo/arch:resourceURI"/></xsl:attribute><xsl:attribute name="title">Get Full Image: <xsl:value-of select="arch:resource/arch:name/arch:string"/> (<xsl:value-of select="arch:resource/oc:metadata/oc:project_name"/>: <xsl:value-of select="arch:resource/arch:links/oc:space_links/oc:link/oc:item_class/oc:name"/>)</xsl:attribute><img> 
																									<xsl:attribute name="src"><xsl:value-of select="arch:resource/arch:content/arch:externalFileInfo/arch:previewURI"/></xsl:attribute>
																									<xsl:attribute name="alt"><xsl:value-of select="arch:resource/arch:name/arch:string"/></xsl:attribute>
																								</img></a>
																		</xsl:otherwise>
																		  ...
																		  <div class="list_tab">
																				<xsl:for-each select="//arch:links/oc:diary_links/oc:link[position() mod 2 = 1]">
																					 <div class="list_tab_row">
																						  ...
																						  <div class="list_tab_cell"><a>
																								  <xsl:attribute name="href">document?UUID=<xsl:value-of select="oc:id"/></xsl:attribute><xsl:value-of select="oc:name"/>
																								  </a>
																						  </div>
																		  ...
																		  <div class="list_tab">
																				<xsl:for-each select="//arch:links/oc:person_links/oc:link[position() mod 2 = 1]">
																					 <div class="list_tab_row">
																						  ...
																						  <div class="list_tab_cell"><a>
																								  <xsl:attribute name="href">person?UUID=<xsl:value-of select="oc:id"/></xsl:attribute><xsl:value-of select="oc:name"/>
										...
										<div id="right_des">
												...
												<div id="media-links">
														...
														<p>
																<a>
																		<xsl:attribute name="href">media?UUID=<xsl:value-of select="arch:resource/@UUID"/>.xml</xsl:attribute>
														...
														<p>
																<a>
																		<xsl:attribute name="href">https://github.com/ekansa/opencontext-<xsl:value-of select="arch:resource/@ownedBy"/>/tree/master/media/<xsl:value-of select="arch:resource/@UUID"/>.xml</xsl:attribute>
