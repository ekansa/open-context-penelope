...
<div id="oc_main_nav">
        ...
        <div class="sides"></div>
        <div class="act_nav"><a href="" title="Viewing list of all projects">Projects</a></div>
        <div class="sides"></div>
        ...
        <div class="sides"></div>
        <div class="n_act_nav"><span title="Browse or click a project below to get details">Details</span></div>
        <div class="sides"></div>
			...
			<tbody>
				...
				<xsl:for-each select="atom:feed/atom:entry">
					<tr>
						...
						<td><xsl:value-of select="arch:project/arch:notes/arch:note[@type='short_des']/arch:string" disable-output-escaping="yes" /></td>
						<td>
