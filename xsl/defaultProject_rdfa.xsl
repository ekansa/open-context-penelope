...
<div id="right_des">
	...
	<div id="all_media" class="bodyText" >
			...
			<table border="0" cellpadding="1">
				<xsl:for-each select="atom:feed/atom:entry/arch:project/arch:links/oc:media_links/oc:link">
						<tr>
							...
							<xsl:when test="oc:type = 'datatable'">	
							<td >
								<a>
									<xsl:attribute name="href">../media/<xsl:value-of select="oc:id"/></xsl:attribute>
									<xsl:attribute name="title">Associated Table (Not indexed by Open Context)</xsl:attribute>
									<img>
										<xsl:attribute name="alt"><xsl:value-of select="oc:name"/></xsl:attribute>
										<xsl:attribute name="src"><xsl:value-of select="oc:thumbnailURI"/></xsl:attribute>
									</img>
		...
		<p class='bodyText'>
				<a>
						<xsl:attribute name="href">../projects/<xsl:value-of select="//arch:project/@UUID"/>.xml</xsl:attribute>
		...
		<p class='bodyText'>
				<a>
						<xsl:attribute name="href">https://github.com/ekansa/Open-Context-Data/tree/master/data/<xsl:value-of select="//arch:project/@UUID"/>/<xsl:value-of select="//arch:project/@UUID"/>.xml</xsl:attribute>
