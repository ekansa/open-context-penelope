...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gml="http://www.opengis.net/gml" xmlns:atom="http://www.w3.org/2005/Atom" xmlns:georss="http://www.georss.org/georss" xmlns:oc="http://about.opencontext.org/schema/property_schema_v1.xsd" xmlns:arch="http://ochre.lib.uchicago.edu/schema/Project/Variable.xsd" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:dc="http://purl.org/dc/elements/1.1/">
...
<xsl:variable name="num_sp_obs">
	<xsl:value-of select="atom:feed/atom:entry/arch:property/oc:manage_info/oc:propStats[@observeType='Spatial']/oc:varTotalObs"/>
</xsl:variable>

<xsl:variable name="max_sp_obs">
	<xsl:value-of select="//oc:propStats[@observeType='Spatial']/oc:graphData/oc:bar/@count[not(. &lt; ../preceding-sibling::oc:bar/@count) and not(. &lt;=
...
<div id="oc_main_nav">
        ...
        <div class="sides"></div>
        <div class="act_nav"><a href="" title="Viewing details of a property">Details</a></div>
        <div class="sides"></div>
...
<div id="left_des">
	...
	<div id="allnotes" class="bodyText">
		...
		<xsl:if test="atom:feed/atom:entry/arch:property/oc:manage_info/oc:propStats[@observeType='Spatial']" >	
			<p class="bodyText">
			<table>
				<tbody>
					<tr>
					...
					<xsl:for-each select="atom:feed/atom:entry/arch:property/oc:manage_info/oc:propStats[@observeType='Spatial']/oc:graphData/oc:bar">
						<tr>
